...
const trustFacts = [
  ...
  "Signed execution receipts persist by run and can be reopened in the reviewer artifact view",
  ...
  return (
    <AppFrame eyebrow="Shape Rotator Submission Build" title="CohortVault">
      <div className="cv-hero">
        <SectionCard
          title="Private AI collaboration for research-heavy teams"
          description="Create a workspace, upload sensitive materials, run secure agent workflows, inspect receipts, and prove revocation works."
        >
        ...
        <div className="cv-receipt">
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 18 }}>
            <div>
              ...
              <h2 style={{ margin: 0 }}>Secure Run proof card</h2>
            </div>
      ...
      <div className="cv-grid" style={{ marginTop: 20 }}>
        <SectionCard className="cv-grid-span-4" title="Why it fits the hackathon" description="Built for the TEE + AI track and aligned to the cohort-as-user framing.">
          <ul>
            <li>Turns privacy and attestation ideas into a product judges can use immediately</li>
